...
- **Verify:** `python3 benchmark/compare.py --protocol-sift <psift.json> --deepsift analysis/findings.json --ground-truth benchmark/ground_truth/<case>_ground_truth.json`
